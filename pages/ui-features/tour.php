...
<head>
  ...
  <link rel="stylesheet" href="../../vendors/bootstrap-tour/bootstrap-tour-standalone.min.css">
...
<body class="sidebar-fixed">
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card" id="tourParagraphElement">
                <div class="card-body">
                  <h4 class="card-title">Heading</h4>
                  <p class="card-text">
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
                    Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, 
                    when an unknown printer took a galley not only five centuries,  Lorem Ipsum is 
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card" id="tourButtonElement">
                <div class="card-body">
                  <h4 class="card-title">Normal buttons</h4>
                  <p class="card-description">Use class <code>.btn .btn-*</code> to create buttons of different colors</p>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card" id="tourRoundedButtonElement">
                <div class="card-body">
                  <h4 class="card-title">Rounded buttons</h4>
                  <p class="card-description">Add class <code>.btn-rounded</code> to create rounded buttons</p>
                  <div class="template-demo">
            ...
            <div class="col-12 grid-margin">
              <div class="card" id="tourTableElement">
                <div class="card-body">
            ...
            <div class="col-12">
              <div class="card" id="tourTextStylesElement">
                <div class="row">
                  <div class="col-md-6">
                    <div class="card-body">
  ...
  <script src="../../vendors/bootstrap-tour/bootstrap-tour-standalone.min.js"></script>
