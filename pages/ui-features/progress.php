            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="page-description">Basic bootstrap progress bars</p>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="page-description">You can give bootstrap colors to progress bars</p>
                  <div class="template-demo">
                    <div class="progress progress-md">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="page-description">Using <code>.stipped-progress-bar</code> class</p>
                  <div class="template-demo">
                    <div class="progress progress-md">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="page-description">Using <code>.progress-bar-animated</code> class</p>
                  <div class="template-demo">
                    <div class="progress progress-md">
