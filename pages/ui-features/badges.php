            ...
            <div class="col-md-4 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">Add class <code>.badge</code></p>
                    ...
                    <table class="table mb-0">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="pr-0 text-right"><div class="badge badge-primary">Default</div></td>
                        </tr>
                        <tr>
                          <td class="pl-0">Primary label</td>
                          <td class="pr-0 text-right"><div class="badge badge-info">Primary</div></td>
                        </tr>
                        <tr>
                  ...
                  <div class="template-demo">
                    <table class="table mb-0">
                      ...
                      <tbody>
                        <tr>
                          <td class="pl-0">Default label</td>
                          <td class="pr-0 text-right"><div class="badge badge-primary badge-pill">Default</div></td>
                        </tr>
                        <tr>
                          <td class="pl-0">Primary label</td>
                          <td class="pr-0 text-right"><div class="badge badge-info badge-pill">Primary</div></td>
                        </tr>
                        <tr>
                          <td class="pl-0">Danger label</td>
                ...
                <div class="card-body">
                  ...
                  <div class="template-demo">
                    <table class="table mb-0">
                      ...
                      <tbody>
                        <tr>
                          <td class="pl-0"><div class="badge badge-outline-primary badge-pill">Default</div></td>
                          <td class="pr-0 text-right"><div class="badge badge-outline-primary">Default</div></td>
                        </tr>
                        <tr>
                          <td class="pl-0"><div class="badge badge-outline-info badge-pill">Primary</div></td>
                          <td class="pr-0 text-right"><div class="badge badge-outline-info">Primary</div></td>
                        </tr>
                        <tr>
