            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <input type="file" class="dropify" data-default-file="../../images/file-icons/dropify-icon-small.png" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <input type="file" class="dropify" data-height="300" data-default-file="../../images/file-icons/dropify-icon-large.png" />
                </div>
              </div>
            </div>
          </div>
