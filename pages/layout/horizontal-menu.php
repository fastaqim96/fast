    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link">
              <i class="mdi mr-2 mdi mdi-apple-safari"></i>
          ...
          <li class="nav-item">
            <a class="nav-link">
              <i class="mdi mr-2 mdi mdi-atom"></i>
          ...
          <li class="nav-item">
            <a class="nav-link">
              <i class="mdi mr-2 mdi mdi-apps"></i>
          ...
          <li class="nav-item">
            <a class="nav-link">
              <i class="mdi mr-2 mdi mdi-airplay"></i>
          ...
          <li class="nav-item mega-menu">
              <a class="nav-link">
                <i class="mdi mr-2 mdi mdi-airballoon"></i>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="wrapper d-flex justify-content-center image-group">
                    <img src="../../images/faces/face1.jpg" alt="profile" class="img-xs rounded-circle">
                    <img src="../../images/faces/face2.jpg" alt="profile" class="img-xs rounded-circle">
                    <img src="../../images/faces/face3.jpg" alt="profile" class="img-xs rounded-circle">
                    <img src="../../images/faces/face4.jpg" alt="profile" class="img-xs rounded-circle">
                    <img src="../../images/faces/face5.jpg" alt="profile" class="img-xs rounded-circle">
                    <img src="../../images/faces/face6.jpg" alt="profile" class="img-xs rounded-circle">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="wrapper d-flex align-items-center py-2 border-bottom">
                    <img class="img-sm rounded-circle" src="../../images/faces/face12.jpg" alt="profile">
                  ...
                  <div class="wrapper d-flex align-items-center py-2 border-bottom">
                    <img class="img-sm rounded-circle" src="../../images/faces/face23.jpg" alt="profile">
                    <div class="wrapper ml-3">
                  ...
                  <div class="wrapper d-flex align-items-center py-2 border-bottom">
                    <img class="img-sm rounded-circle" src="../../images/faces/face26.jpg" alt="profile">
                    <div class="wrapper ml-3">
                  ...
                  <div class="wrapper d-flex align-items-center py-2 border-bottom">
                    <img class="img-sm rounded-circle" src="../../images/faces/face27.jpg" alt="profile">
                    <div class="wrapper ml-3">
                      <h6 class="mb-0"><strong>Madeline Kennedy</strong></h6>
                  ...
                  <div class="wrapper d-flex align-items-center py-2 mb-4">
                    <img class="img-sm rounded-circle" src="../../images/faces/face25.jpg" alt="profile">
                    <div class="wrapper ml-3">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-5 pl-md-4">
                      <img class="rounded img-lg" src="../../images/faces/face4.jpg" alt="profile image">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="d-flex row mt-5">
                    <div class="col">
                      <p class="text-left mb-2">2.86 GB free</p>
                      <h4 class="text-left"><strong>58.8%</strong></h4>
                    </div>
                    <div class="col">
