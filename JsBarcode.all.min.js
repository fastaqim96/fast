...
!(function (t) {
      ...
      f = (function (t) {
        function e() {
          ...
          return (
            ...
            (n.message = "The encoding does not start with a start character."),
            n
          );
        }
        return a(e, t), e;
  ...
  function (t, e, n) {
    ...
    function a(t, e, n) {
      for (var r = 0; r < t.length; r++) {
        ...
        (u.width = Math.ceil(Math.max(a, f))),
          (u.height = o(u, s)),
          (u.barcodePadding = i(a, f, s));
      }
    }
    function u(t) {
  ...
  function (t, e, n) {
    ...
    function c(t) {
      ...
      return n[0].length === t.length
        ? t
        : n[0] + String.fromCharCode(206) + s(t.substring(n[0].length));
    }
    function f(t) {
      ...
      h = (function (t) {
        function e(n, r) {
          if ((o(this, e), n.search(/^[\x00-\x7F\xC8-\xD3]+$/) !== -1))
            var a = i(this, t.call(this, u(n), r));
    ...
    var s = n(1),
      ...
      p = (function (t) {
        function e(n, r) {
          ...
          return (
            !r.flat && r.fontSize > 10 * r.width
              ? (a.fontSize = 10 * r.width)
              : (a.fontSize = r.fontSize),
            (a.guardHeight = r.height + a.fontSize / 2 + r.textMargin),
            (a.lastChar = r.lastChar),
            a
          );
        }
        return (
          ...
          (e.prototype.flatEncoding = function () {
            ...
            return (
              (e += "101"),
              (e += t.encode(this.data.substr(1, 6), n)),
              (e += "01010"),
              (e += t.encode(this.data.substr(7, 6), "RRRRRR")),
              (e += "101"),
        ...
        return (
          ...
          (e.prototype.encode = function () {
            var t = new s["default"](),
              ...
              n = "1011";
            return (
              (n += t.encode(this.data, e, "01")), { data: n, text: this.text }
            );
          }),
          e
        );
        ...
        return (
          ...
          (e.prototype.encode = function () {
            var t = new s["default"](),
              ...
              n = "1011";
            return (
              (n += t.encode(this.data, this.structure[e], "01")),
          ...
          (e.prototype.checksum = function () {
            var t = 0;
            return (
              (t += 3 * parseInt(this.data[0])),
              (t += 9 * parseInt(this.data[1])),
              (t += 3 * parseInt(this.data[2])),
              (t += 9 * parseInt(this.data[3])),
              (t += 3 * parseInt(this.data[4])),
              t % 10
            );
          }),
          e
    ...
    var s = n(1),
      ...
      p = (function (t) {
        function e(n, r) {
          ...
          var a = i(this, t.call(this, n, r));
          return (
            (a.displayValue = r.displayValue),
            r.fontSize > 10 * r.width
              ? (a.fontSize = 10 * r.width)
              : (a.fontSize = r.fontSize),
            (a.guardHeight = r.height + a.fontSize / 2 + r.textMargin),
            a
        ...
        return (
          ...
          (e.prototype.flatEncoding = function () {
            ...
            return (
              (e += "101"),
              (e += t.encode(this.data.substr(0, 6), "LLLLLL")),
              (e += "01010"),
              (e += t.encode(this.data.substr(6, 6), "RRRRRR")),
              (e += "101"),
              { data: e, text: this.text }
            );
          }),
        ...
        return (
          ...
          (t.prototype.prepareSVG = function () {
            ...
            this.setSvgAttributes(n, e),
              this.options.background &&
                u(0, 0, n, e, this.svg).setAttribute(
                  "style",
          ...
          (t.prototype.drawSvgBarcode = function (t, e, n) {
            ...
            for (var i = 0, a = 0, s = 0; s < o.length; s++)
              (a = s * e.width + n.barcodePadding),
                "1" === o[s]
                  ? i++
                  : i > 0 &&
                    (u(a - e.width * i, r, e.width * i, e.height, t), (i = 0));
  ...
  function (t, e, n) {
    ...
    function o(t, e) {
      E.prototype[e] = E.prototype[e.toUpperCase()] = E.prototype[
        e.toLowerCase()
      ] = function (n, r) {
        var o = this;
    ...
    for (var P in c["default"])
      c["default"].hasOwnProperty(P) && o(c["default"], P);
