                ...
                <div class="card">
                  <div class="card-body">
                    <?php
                        ...
                        $sql = "SELECT * from client WHERE c_id=:client";
                        $query = $dbh -> prepare($sql);
                    ...
                    <h4 class="card-title" align="center">Edit Client</h4>
                    <div class="form-group row">
                      <div class="col-lg-2">
                        <label class="col-form-label">Full Name</label>
                      </div>
                      <div class="col-lg-10">
                        <input class="form-control" maxlength="100" name="name" id="defaultconfig" type="text" value="<?php echo htmlentities($result->c_name);?>">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-2">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control" maxlength="12" name="ICNo" id="defaultconfig-3" type="text" value="<?php echo htmlentities($result->c_ic);?>">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-2">
                      ...
                      <div class="col-lg-4">
                        <input class="form-control" maxlength="15" name="phone" type="text" value="<?php echo htmlentities($result->c_phone);?>">
                      </div>
                      ...
                      <div class="col-lg-5">
                        <input class="form-control" name="email" type="email" value="<?php echo htmlentities($result->c_email);?>">
                      </div>
                    </div>                    
                    <div class="form-group row">
                      <div class="col-lg-2">
                      ...
                      <div class="col-lg-10">
                        <textarea id="maxlength-textarea" name="addr" class="form-control" maxlength="100" rows="2"><?php echo htmlentities($result->c_addr);?></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-2">
                      ...
                      <div class="col-lg-4">
                        <input class="form-control" name="postcode" maxlength="5" type="text" id="defaultconfig-2" value="<?php echo htmlentities($result->c_postcode);?>">
                      </div>
                      ...
                      <div class="col-lg-5">
                        <input class="form-control" name="district" id="defaultconfig-3" type="text" value="<?php echo htmlentities($result->c_district);?>">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-2">
                      ...
                      <div class="col-lg-10">
                        <select class="js-example-basic-single" name="state" style="width:100%">
                          <option <?php if(htmlentities($result->c_state)=='TERENGGANU') { 'selected="selected"'; } ?> value="TERENGGANU"> Terengganu Darul Iman</option>
                          ...
                          <option <?php if(htmlentities($result->c_state)=='KEDAH') { 'selected="selected"'; } ?> value="KEDAH">Kedah Darul Aman</option>
                    ...
                    <div align="right" class="col-lg-12">
                      ...
                      <a href="http://fyppresentation.com/fastaqimresources/clients.php" class="btn-warning btn">Back</a>
                    </div>
                  </form>
                </div>
              </div>
