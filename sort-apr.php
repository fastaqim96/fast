                    ...
                    <div class="col-12">
                      <table id="order-listing" class="table">
                        ...
                        <tbody>
                          <?php
                          $year=date('Y');
                          $sql = "SELECT DISTINCT client.*, policy.* FROM policy JOIN client ON client.c_ic=policy.c_ic WHERE policy.expired_date LIKE '%/04/$year%' ORDER BY policy.expired_date ASC";
